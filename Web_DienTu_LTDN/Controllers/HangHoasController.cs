...
namespace Web_DienTu_LTDN.Controllers
{
    ...
    {
        private readonly NamShop2025Context _context;

        public HangHoasController(NamShop2025Context context)
        {
            _context = context;
        }
        ...
        {
            var namShop2025Context = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
            return View(await namShop2025Context.ToListAsync());
        }
